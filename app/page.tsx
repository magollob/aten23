...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      <section className="relative z-10 min-h-screen flex flex-col items-center justify-start pb-8">
        {/* Hero banner — mobile */}
        ...
        <div className="w-full hidden md:block">
          <Image
            src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/headdesktop-1o3tOocHH1JdCNTyfFkyYftW8rAMaq.webp"
            alt="Smart Ilha — Lançamentos 2026 Microwear, Os Novos Series 11"
            width={1920}
            height={680}
            priority
        ...
        <button
          ...
          className="animate-bounce text-orange-500 hover:text-orange-400 transition-colors my-6 md:my-8"
        >
        ...
        <div className="w-full max-w-md md:max-w-5xl mb-6 md:mb-10">
          <div className="text-center mb-6 md:mb-8">
            <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-white mb-2 md:mb-3 tracking-tight uppercase text-balance">
